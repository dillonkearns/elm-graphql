...
module Hasura.Object.Online_users_min_fields exposing (id, last_seen, username)
...
id : SelectionSet (Maybe Int) Hasura.Object.Online_users_min_fields
id =
    Object.selectionForField "(Maybe Int)" "id" [] (Decode.int |> Decode.nullable)


last_seen : SelectionSet (Maybe Hasura.ScalarCodecs.Timestamptz) Hasura.Object.Online_users_min_fields
last_seen =
...
username : SelectionSet (Maybe String) Hasura.Object.Online_users_min_fields
username =
