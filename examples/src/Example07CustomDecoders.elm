...
{-
   ...
   If we generated this code without specifying `--scalar-decoders CustomScalarCodecs`
   ...
   Since we supplied a custom decoder with `--scalar-decoders CustomScalarCodecs`,
   ...
   https://github.com/dillonkearns/elm-graphql/blob/scalar-decoders/examples/src/CustomScalarCodecs.elm
