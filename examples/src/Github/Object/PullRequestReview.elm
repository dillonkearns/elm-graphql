...
submittedAt =
    Object.selectionForField "(Maybe ScalarDecoders.DateTime)" "submittedAt" [] (Github.ScalarDecoders.decoders |> Github.Scalar.unwrapCodecs |> .decoderDateTime |> Decode.nullable)
