...
submittedAt =
    Object.selectionForField "(Maybe ScalarDecoders.DateTime)" "submittedAt" [] (Github.ScalarDecoders.codecs |> Github.Scalar.unwrapCodecs |> .codecDateTime |> .decoder |> Decode.nullable)
