...
environment =
    Object.selectionForField "environment" [] (Decode.string |> Decode.nullable)
...
payload =
    Object.selectionForField "payload" [] (Decode.string |> Decode.nullable)
...
state =
    Object.selectionForField "state" [] (Github.Enum.DeploymentState.decoder |> Decode.nullable)
