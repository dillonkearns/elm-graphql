...
edges : SelectionSet edges Github.Object.LabelEdge -> FieldDecoder (Maybe (List (Maybe edges))) Github.Object.LabelConnection
edges object =
    Object.selectionFieldDecoder "edges" [] object (identity >> Decode.maybe >> Decode.list >> Decode.maybe)


nodes : SelectionSet nodes Github.Object.Label -> FieldDecoder (Maybe (List (Maybe nodes))) Github.Object.LabelConnection
nodes object =
