...
{-| A list of edges.
-}
edges : SelectionSet edges Github.Object.ReviewRequestEdge -> FieldDecoder (Maybe (List (Maybe edges))) Github.Object.ReviewRequestConnection
edges object =
...
{-| A list of nodes.
-}
nodes : SelectionSet nodes Github.Object.ReviewRequest -> FieldDecoder (Maybe (List (Maybe nodes))) Github.Object.ReviewRequestConnection
nodes object =
