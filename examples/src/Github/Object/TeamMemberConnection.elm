...
{-| A list of edges.
-}
edges : SelectionSet edges Github.Object.TeamMemberEdge -> FieldDecoder (Maybe (List (Maybe edges))) Github.Object.TeamMemberConnection
edges object =
...
{-| A list of nodes.
-}
nodes : SelectionSet nodes Github.Object.User -> FieldDecoder (Maybe (List (Maybe nodes))) Github.Object.TeamMemberConnection
nodes object =
