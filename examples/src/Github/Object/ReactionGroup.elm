...
content =
    Object.selectionForField Nothing "content" [] Github.Enum.ReactionContent.decoder
...
createdAt =
    Object.selectionForField (Just "DateTime") "createdAt" [] (Object.scalarDecoder |> Decode.map Github.Scalar.DateTime |> Decode.nullable)
...
viewerHasReacted =
    Object.selectionForField (Just "Boolean") "viewerHasReacted" [] Decode.bool
