...
digestMethod =
    Object.fieldDecoder "digestMethod"
        []
        (Decode.oneOf
            [ Decode.string
...
idpCertificate =
    Object.fieldDecoder "idpCertificate"
        []
        (Decode.oneOf
            [ Decode.string
            , Decode.float |> Decode.map String.fromFloat
            ...
            |> Decode.map Github.Scalar.X509Certificate
            |> Decode.nullable
        )
...
signatureMethod =
    Object.fieldDecoder "signatureMethod"
        []
        (Decode.oneOf
            [ Decode.string
            , Decode.float |> Decode.map String.fromFloat
