...
memberAccessResourcePath =
    Object.selectionForField (Just "URI") "memberAccessResourcePath" [] (Object.scalarDecoder |> Decode.map Github.Scalar.Uri)
...
memberAccessUrl =
    Object.selectionForField (Just "URI") "memberAccessUrl" [] (Object.scalarDecoder |> Decode.map Github.Scalar.Uri)
...
role =
    Object.selectionForField Nothing "role" [] Github.Enum.TeamMemberRole.decoder
