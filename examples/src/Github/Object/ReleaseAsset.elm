...
contentType =
    Object.selectionForField (Just "String") "contentType" [] Decode.string
...
downloadCount =
    Object.selectionForField (Just "Int") "downloadCount" [] Decode.int
...
downloadUrl =
    Object.selectionForField (Just "URI") "downloadUrl" [] (Object.scalarDecoder |> Decode.map Github.Scalar.Uri)
...
size =
    Object.selectionForField (Just "Int") "size" [] Decode.int
