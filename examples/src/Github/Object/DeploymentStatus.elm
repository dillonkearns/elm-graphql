...
environmentUrl =
    Object.selectionForField (Just "URI") "environmentUrl" [] (Object.scalarDecoder |> Decode.map Github.Scalar.Uri |> Decode.nullable)
...
logUrl =
    Object.selectionForField (Just "URI") "logUrl" [] (Object.scalarDecoder |> Decode.map Github.Scalar.Uri |> Decode.nullable)
...
state =
    Object.selectionForField Nothing "state" [] Github.Enum.DeploymentStatusState.decoder
