...
{-| A list of edges.
-}
edges : SelectionSet edges Github.Object.UserEdge -> FieldDecoder (Maybe (List (Maybe edges))) Github.Object.UserConnection
edges object =
...
{-| A list of nodes.
-}
nodes : SelectionSet nodes Github.Object.User -> FieldDecoder (Maybe (List (Maybe nodes))) Github.Object.UserConnection
nodes object =
