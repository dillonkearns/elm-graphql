...
authoredByCommitter =
    Object.selectionForField (Just "Boolean") "authoredByCommitter" [] Decode.bool
...
authoredDate =
    Object.selectionForField (Just "DateTime") "authoredDate" [] (Object.scalarDecoder |> Decode.map Github.Scalar.DateTime)
...
committedDate =
    Object.selectionForField (Just "DateTime") "committedDate" [] (Object.scalarDecoder |> Decode.map Github.Scalar.DateTime)
...
committedViaWeb =
    Object.selectionForField (Just "Boolean") "committedViaWeb" [] Decode.bool
...
message =
    Object.selectionForField (Just "String") "message" [] Decode.string
...
messageBody =
    Object.selectionForField (Just "String") "messageBody" [] Decode.string
...
messageBodyHTML =
    Object.selectionForField (Just "HTML") "messageBodyHTML" [] (Object.scalarDecoder |> Decode.map Github.Scalar.Html)
...
messageHeadline =
    Object.selectionForField (Just "String") "messageHeadline" [] Decode.string
...
messageHeadlineHTML =
    Object.selectionForField (Just "HTML") "messageHeadlineHTML" [] (Object.scalarDecoder |> Decode.map Github.Scalar.Html)
...
pushedDate =
    Object.selectionForField (Just "DateTime") "pushedDate" [] (Object.scalarDecoder |> Decode.map Github.Scalar.DateTime |> Decode.nullable)
...
tarballUrl =
    Object.selectionForField (Just "URI") "tarballUrl" [] (Object.scalarDecoder |> Decode.map Github.Scalar.Uri)
...
treeResourcePath =
    Object.selectionForField (Just "URI") "treeResourcePath" [] (Object.scalarDecoder |> Decode.map Github.Scalar.Uri)
...
treeUrl =
    Object.selectionForField (Just "URI") "treeUrl" [] (Object.scalarDecoder |> Decode.map Github.Scalar.Uri)
...
zipballUrl =
    Object.selectionForField (Just "URI") "zipballUrl" [] (Object.scalarDecoder |> Decode.map Github.Scalar.Uri)
