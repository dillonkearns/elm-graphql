...
authoredDate =
    Object.fieldDecoder "authoredDate"
        []
        (Decode.oneOf
            [ Decode.string
...
committedDate =
    Object.fieldDecoder "committedDate"
        []
        (Decode.oneOf
            [ Decode.string
            , Decode.float |> Decode.map String.fromFloat
...
messageBodyHTML =
    Object.fieldDecoder "messageBodyHTML"
        []
        (Decode.oneOf
            [ Decode.string
            , Decode.float |> Decode.map String.fromFloat
...
messageHeadlineHTML =
    Object.fieldDecoder "messageHeadlineHTML"
        []
        (Decode.oneOf
            [ Decode.string
            , Decode.float |> Decode.map String.fromFloat
...
pushedDate =
    Object.fieldDecoder "pushedDate"
        []
        (Decode.oneOf
            [ Decode.string
            , Decode.float |> Decode.map String.fromFloat
...
tarballUrl =
    Object.fieldDecoder "tarballUrl"
        []
        (Decode.oneOf
            [ Decode.string
            , Decode.float |> Decode.map String.fromFloat
...
treeResourcePath =
    Object.fieldDecoder "treeResourcePath"
        []
        (Decode.oneOf
            [ Decode.string
            , Decode.float |> Decode.map String.fromFloat
...
zipballUrl =
    Object.fieldDecoder "zipballUrl"
        []
        (Decode.oneOf
            [ Decode.string
            , Decode.float |> Decode.map String.fromFloat
