...
beginIndice =
    Object.selectionForField (Just "Int") "beginIndice" [] Decode.int
...
endIndice =
    Object.selectionForField (Just "Int") "endIndice" [] Decode.int
...
text =
    Object.selectionForField (Just "String") "text" [] Decode.string
