...
cost =
    Object.selectionForField (Just "Int") "cost" [] Decode.int
...
limit =
    Object.selectionForField (Just "Int") "limit" [] Decode.int
...
nodeCount =
    Object.selectionForField (Just "Int") "nodeCount" [] Decode.int
...
remaining =
    Object.selectionForField (Just "Int") "remaining" [] Decode.int
...
resetAt =
    Object.selectionForField (Just "DateTime") "resetAt" [] (Object.scalarDecoder |> Decode.map Github.Scalar.DateTime)
