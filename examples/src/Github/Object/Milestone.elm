...
dueOn =
    Object.selectionForField (Just "DateTime") "dueOn" [] (Object.scalarDecoder |> Decode.map Github.Scalar.DateTime |> Decode.nullable)
...
state =
    Object.selectionForField Nothing "state" [] Github.Enum.MilestoneState.decoder
