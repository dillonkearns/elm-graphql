...
baseRefOid =
    Object.fieldDecoder "baseRefOid"
        []
        (Decode.oneOf
            [ Decode.string
...
headRefOid =
    Object.fieldDecoder "headRefOid"
        []
        (Decode.oneOf
            [ Decode.string
            , Decode.float |> Decode.map String.fromFloat
...
revertResourcePath =
    Object.fieldDecoder "revertResourcePath"
        []
        (Decode.oneOf
            [ Decode.string
            , Decode.float |> Decode.map String.fromFloat
