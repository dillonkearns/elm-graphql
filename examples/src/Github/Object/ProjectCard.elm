...
note =
    Object.selectionForField (Just "String") "note" [] (Decode.string |> Decode.nullable)
...
state =
    Object.selectionForField Nothing "state" [] (Github.Enum.ProjectCardState.decoder |> Decode.nullable)
