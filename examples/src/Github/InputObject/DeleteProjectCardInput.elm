...
encode input =
    Encode.maybeObject
        [ ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ), ( "cardId", Encode.string input.cardId |> Just ) ]


{-| Type for the DeleteProjectCardInput input object.
-}
type alias DeleteProjectCardInput =
    { clientMutationId : OptionalArgument String, cardId : String }
