...
type alias GreetingOptionalFields =
    { language : OptionalArgument Starwars.Enum.Language.Language, options : OptionalArgument GreetingOptions }


{-| Type for the Greeting input object.
-}
type alias Greeting =
    { language : OptionalArgument Starwars.Enum.Language.Language, name : String, options : OptionalArgument GreetingOptions }
