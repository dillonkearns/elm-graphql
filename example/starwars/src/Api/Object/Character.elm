...
friends : ({ first : Maybe Int, after : Maybe String, last : Maybe Int, before : Maybe String } -> { first : Maybe Int, after : Maybe String, last : Maybe Int, before : Maybe String }) -> Object friends Api.Object.CharacterConnection -> FieldDecoder friends Api.Object.Character
