        ...
        [ test "simple scalar converts for query" <|
            \() ->
                meField
                    ...
                    |> Expect.equal
                        (Ok """me : SelectionSet String RootQuery
me =
        ...
        , test "converts for object" <|
            \() ->
                meField
                    ...
                    |> Expect.equal
                        (Ok """me : SelectionSet String Api.Object.Foo
me =
      Object.selectionForField "String" "me" [] (Decode.string)
""")
        , test "simple object with no args" <|
            \() ->
                ...
                , args = []
                    ...
                    |> Field.generateForObject (contextWith Nothing) (ClassCaseName.build "RootQueryObject")
                    |> Expect.equal
                        (Ok """droid : SelectionSet decodesTo Api.Object.Droid -> SelectionSet decodesTo RootQuery
droid object_ =
        ...
        , test "simple interface with no args" <|
            \() ->
                ...
                , args = []
                    ...
                    |> Expect.equal
                        (Ok """hero : SelectionSet decodesTo Api.Interface.Character -> SelectionSet decodesTo RootQuery
hero object_ =
        ...
        , test "simple object with no args for object" <|
            \() ->
                ...
                , args = []
                    ...
                    |> Field.generateForObject (contextWith Nothing) (ClassCaseName.build "Foo")
                    |> Expect.equal
                        (Ok """droid : SelectionSet decodesTo Api.Object.Droid -> SelectionSet decodesTo Api.Object.Foo
droid object_ =
      Object.selectionForCompositeField "droid" [] (object_) (identity)
""")
        , test "list of objects with no args" <|
            \() ->
                ...
                , args = []
                    ...
                    |> Field.generateForObject (contextWith Nothing) (ClassCaseName.build "Foo")
                    |> Expect.equal
                        (Ok """droid : SelectionSet decodesTo Api.Object.Droid -> SelectionSet (List decodesTo) Api.Object.Foo
droid object_ =
        ...
        , test "with required args" <|
            \() ->
                ...
                , args =
                    ...
                    |> Field.generateForObject (contextWith Nothing) (ClassCaseName.build "RootQueryObject")
                    |> Expect.equal
                        (Ok """type alias HumanRequiredArguments = { id : String }
        ...
        , test "with optional args" <|
            \() ->
                ...
                , args =
                    ...
                    |> Field.generateForObject (contextWith Nothing) (ClassCaseName.build "RootQueryObject")
                    |> Expect.equal
                        (Ok """type alias MenuItemsOptionalArguments = { contains : OptionalArgument String }
        ...
        , test "normalizes reserved names" <|
            \() ->
                ...
                , args = []
                    ...
                    |> Expect.equal
                        (Ok """type_ : SelectionSet String Api.Object.TreeEntry
type_ =
