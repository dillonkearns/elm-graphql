module Graphqelm.Encode exposing (Value, bool, enum, int, list, null, object, serialize, string)

{-| `Graphqelm.Encode.Value`s are usually low-level details used by generated code.
Currently users need to pass Encode Values in for InputObjects arguments, but
otherwise they are only used by the code generated by the `graphqelm` CLI tool.

@docs Value, null, bool, enum, int, list, string, object
