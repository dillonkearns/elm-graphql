module Graphql.SelectionSet exposing (FragmentSelectionSet(FragmentSelectionSet), SelectionSet(SelectionSet), empty, fieldSelection, hardcoded, map, succeed, with)
